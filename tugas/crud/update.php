...
if (isset($_POST['sub,it'])) {
    $nama_sekolah = $POST['nama'];
    $alamat_sekolah =  $POST['alamat'];
    ...
    <div class='card w-50 m-auto p-3'> 
        ...
        <form method="post"> 
            ...
            <div class="mb-3"> 
                ...
                <input type="text" class="form-control" id="alamat" name="alamat" value="<?php echo $nama_sekolah?>"> 
            </div> 
